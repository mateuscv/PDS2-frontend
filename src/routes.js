...
const Home = React.lazy(() => import("./views/youtube/home/Home"));
const Fire = React.lazy(() => import("./views/youtube/fire/Fire"));
const Inscription = React.lazy(() =>
  import("./views/youtube/inscriptions/Inscriptions")
);
const Library = React.lazy(() => import("./views/youtube/library/Library"));
const View = React.lazy(() => import("./views/youtube/view/View"));
const Profile = React.lazy(() => import("./views/youtube/profile/Profile"));
